...
You will use {{% resource_link "7bc25969-2431-4944-bfbc-3eded55223d7" "Dave's Redistricting App (DRA)" %}} to draw the districts. (Note: The app will not run in Chrome, but should work in Safari, Firefox, and Internet Explorer. You will need to download the Silverlight plugin for the app to work.)
